...
const HomeUI = () => {
  return (
    ...
    <ul className='flex gap-6 mt-10 list-style-none overflow-x-0 scroollbar-w-none'>
        <button className='flex-shrink-0 p-[18px] w-[228px] flex flex-col items-center rounded-[12px] bg-[#283045] cursor-pointer '>
        ...
        <li className='flex-shrink-0 p-[18px] w-[228px] flex flex-col items-center rounded-[12px] bg-[#283045] cursor-pointer'>
